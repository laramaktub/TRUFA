...
prog_set = set(["FASTQC1","DUP","TRIM","CUTADAPT","BLAT_UNIVEC","BLAT_ECOLI","BLAT_SCERE","BLAT_CUSTOM_READS", "FASTQC2","TRINITY","ASSEMBLY_QUAL","CDHITEST","BOWTIE1","BLAT_CEGMA","BLAT_UNIREF","BLAT_NR","BLAT_CUSTOM_ASS","HMMER_CEGMA","HMMER_PFAMA","HMMER_PFAMB","HMMER_CUSTOM","BLAST_NR","BLASTPLUS_NR","BLAST2GO","INTERPROSCAN", "HISAT2","CUFFDIFF","CUFFLINKS","RSEM","EXPRESS"])

cleaning_progs = set(["DUP", "TRIM","CUTADAPT","BLAT_ECOLI","BLAT_SCERE","BLAT_UNIVEC","BLAT_CUSTOM_READS"])
ass_map_progs = set(["TRINITY","ASSEMBLY_QUAL","CDHITEST","BOWTIE1","HISAT2"])
